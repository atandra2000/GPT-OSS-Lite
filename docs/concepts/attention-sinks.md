...
- [attention-and-positional.md](attention-and-positional.md) — RoPE, YaRN scaling, `apply_rope`
...
See [attention-and-positional.md](attention-and-positional.md) for parameter semantics.
...
`apply_rope` is imported from `models.rotary` — see [attention-and-positional.md](attention-and-positional.md).
...
- [`models/attention.py:GPTOSSAttention`](../../models/attention.py) — projections, sink bias, YaRN, alternation
- [`models/attention.py:causal_attention`](../../models/attention.py) — SDPA path with window + sink
- [`models/attention.py:manual_causal_attention`](../../models/attention.py) — FP32 test oracle
- [`models/attention.py:SINK_CLAMP_MIN`](../../models/attention.py) / [`models/attention.py:SINK_CLAMP_MAX`](../../models/attention.py) — clamp bounds
